<x-layout>
    ...
    <div class="antialiased bg-gray-50 flex flex-col md:flex-row">

        <button id="toggleSidebar" type="button"
            class="p-2 mt-2 ms-3 text-sm w-10 text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
        ...
        <aside id="default-sidebar"
            class="fixed hidden md:block w-64 mt-16 ml-4 z-40 md:w-64 md:rounded-lg md:m-4 rounded-lg bg-white md:translate-x-0 dark:bg-gray-800 md:relative"
            aria-label="sidebar">
            <div class="overflow-y-auto py-5 px-3 bg-white dark:bg-gray-800">
                <ul class="space-y-2">
                    <li>
                        <a href="#"
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div
                        ...
                        <button type="button" onclick="window.location.href='{{ route('post.create') }}'"
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                <th scope="col" class="px-4 py-3">Article Title</th>
