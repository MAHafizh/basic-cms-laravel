    <div class="antialiased bg-gray-50 flex">
        ...
        <aside id="default-sidebar"
            class="hidden md:block w-64 m-4 rounded-lg transition-transform -translate-x-full bg-white md:translate-x-0 dark:bg-gray-800"
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div
                        ...
                        <button type="button" onclick="window.location.href='/user/post/create'"
